...
(1, 1, '2023-10-25', 1200.00),
(2, 2, '2023-10-26', 900.00);
...
(1, 'Toocki 3A Cable USB', 'Toocki 3A Cable USB Type C Fast Charge Charger Charging Type C Type-C USB-C Cable For Xiaomi Redmi Realme Poco F5 Smartphone 5G', 1, '900'),
(2, 'I7S Tws Double Dual', 'I7S Tws Double Dual Mini Wireless 4.1 Bluetooth Earphone With Power Case - White - Bluetooth Earbud', 2, '1200');
